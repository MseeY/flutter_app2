...
import 'package:flutter_app2/core/utils/currency_utils.dart';
...
//      arguments: widget.restaurant);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 5),
                  CustomRating(
                    rating: widget.restaurant.ratingStar!.toDouble(),
                    review: widget.restaurant.review!.toInt(),
                  ),
                  SizedBox(height: 5),
                  _cuisines(),
                  SizedBox(height: 5),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: NetworkImage(widget.restaurant.imgURL.toString()),
          fit: BoxFit.cover
        ),
  ...
  Widget _cuisines() {
    return Text(
      widget.restaurant.cuisines.toString(),
      style: TextStyle(
